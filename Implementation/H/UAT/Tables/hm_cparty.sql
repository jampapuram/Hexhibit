...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HM_CPARTY
--------------------------------------------------------

  CREATE TABLE HM_CPARTY 
   (	CPARTY_ID VARCHAR2(100 BYTE), 
	RECTYPE VARCHAR2(1 BYTE), 
	CURRNO NUMBER(5,0), 
	NAME VARCHAR2(500 BYTE), 
	CBL_APPROVED_YN VARCHAR2(1 BYTE) DEFAULT 'N', 
	COUP_TYPE VARCHAR2(100 BYTE), 
  ...
  TABLESPACE HM_TBS ;
--------------------------------------------------------
--  DDL for Index CT_UK_HCPARTY
--------------------------------------------------------

  CREATE UNIQUE INDEX CT_UK_HCPARTY ON HM_CPARTY (CPARTY_ID, CURRNO) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 65536 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE HHINDX_TBS ;
--------------------------------------------------------
--  Constraints for Table HM_CPARTY
--------------------------------------------------------

  ALTER TABLE HM_CPARTY MODIFY (CR_ID NOT NULL ENABLE);
 
  ALTER TABLE HM_CPARTY MODIFY (CR_DT NOT NULL ENABLE);
 
  ALTER TABLE HM_CPARTY MODIFY (ACTIVE NOT NULL ENABLE);
 
  ALTER TABLE HM_CPARTY MODIFY (ACTIVATION_DT NOT NULL ENABLE);
 
  ALTER TABLE HM_CPARTY MODIFY (DEACTIVATION_DT NOT NULL ENABLE);
