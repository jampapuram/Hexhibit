...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HM_MGMT
--------------------------------------------------------

  CREATE TABLE HM_MGMT 
  ...
  TABLESPACE HM_TBS ;
--------------------------------------------------------
--  DDL for Index CT_UK_HM
--------------------------------------------------------

  CREATE UNIQUE INDEX CT_UK_HM ON HM_MGMT (MGMT_GROUP) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 65536 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE HHINDX_TBS ;
--------------------------------------------------------
--  Constraints for Table HM_MGMT
--------------------------------------------------------

  ALTER TABLE HM_MGMT MODIFY (CR_ID NOT NULL ENABLE);
 
  ALTER TABLE HM_MGMT MODIFY (CR_DT NOT NULL ENABLE);
 
  ALTER TABLE HM_MGMT MODIFY (ACTIVE NOT NULL ENABLE);
 
  ALTER TABLE HM_MGMT MODIFY (ACTIVATION_DT NOT NULL ENABLE);
 
  ALTER TABLE HM_MGMT MODIFY (DEACTIVATION_DT NOT NULL ENABLE);
