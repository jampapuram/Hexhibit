...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HI_OPTIONSDEAL_CURR
--------------------------------------------------------

  CREATE TABLE HI_OPTIONSDEAL_CURR 
  ...
  TABLESPACE HHI_TBS ;
--------------------------------------------------------
--  DDL for Index CT_HI_ODEALS_CURR
--------------------------------------------------------

  CREATE UNIQUE INDEX CT_HI_ODEALS_CURR ON HI_OPTIONSDEAL_CURR (AMC_CODE, DEAL_ID, RECTYPE, CURRNO) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 65536 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE HHI_TBS ;
--------------------------------------------------------
--  Constraints for Table HI_OPTIONSDEAL_CURR
--------------------------------------------------------

  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (AMC_CODE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (DEAL_ID NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (RECTYPE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (CURRNO NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (SCHEME NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (TRADE_DATE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (VALUE_DATE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (BOOK_DATE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (TRAN_TYPE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (OPTION_SECURITY NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (OPTION_TYPE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (STK_EXCH NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (CURRENCY NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (INVEST_TYPE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (CUSTODIAN NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (CALL_PUT NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (EXPIRY_DATE NOT NULL ENABLE);
 
  ALTER TABLE HI_OPTIONSDEAL_CURR MODIFY (COVERED_CALL_YN NOT NULL ENABLE);
