...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HI_AUDITLOG
--------------------------------------------------------

  CREATE TABLE HI_AUDITLOG 
   (	AUDITLOG_ID NUMBER(12,0), 
	PROCEDURE_NAME VARCHAR2(500 BYTE), 
	TABLE_NAME VARCHAR2(500 BYTE), 
	REPO_NAME VARCHAR2(500 BYTE), 
	PROCEDURE_FLAG VARCHAR2(1 BYTE), 
	TABLE_FLAG VARCHAR2(1 BYTE), 
	REPO_FLAG VARCHAR2(1 BYTE), 
	AUDIT_DT DATE, 
	FF_N1 NUMBER(16,2), 
	FF_N2 NUMBER(16,2), 
	FF_N3 NUMBER(16,2), 
