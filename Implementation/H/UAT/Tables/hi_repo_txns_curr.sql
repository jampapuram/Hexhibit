...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HI_REPO_TXNS_CURR
--------------------------------------------------------

  CREATE TABLE HI_REPO_TXNS_CURR 
  ...
  TABLESPACE HHI_TBS ;
--------------------------------------------------------
--  DDL for Index CT_UK_HIREPO_TXNS_CURR
--------------------------------------------------------

  CREATE UNIQUE INDEX CT_UK_HIREPO_TXNS_CURR ON HI_REPO_TXNS_CURR (AMC_CODE, APP_REFER, DEAL_ID, SCHEME, CURRENCY, VALUE_DATE, RECTYPE) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 65536 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE HHINDX_TBS ;
--------------------------------------------------------
--  Constraints for Table HI_REPO_TXNS_CURR
--------------------------------------------------------

  ALTER TABLE HI_REPO_TXNS_CURR MODIFY (CR_ID NOT NULL ENABLE);
 
  ALTER TABLE HI_REPO_TXNS_CURR MODIFY (CR_DT NOT NULL ENABLE);
 
  ALTER TABLE HI_REPO_TXNS_CURR MODIFY (ACTIVE NOT NULL ENABLE);
 
  ALTER TABLE HI_REPO_TXNS_CURR MODIFY (ACTIVATION_DT NOT NULL ENABLE);
 
  ALTER TABLE HI_REPO_TXNS_CURR MODIFY (DEACTIVATION_DT NOT NULL ENABLE);
