...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HI_EQUITY_CHECK
--------------------------------------------------------

  CREATE TABLE HI_EQUITY_CHECK 
   (	EQUITY_ID NUMBER(16,0), 
	...
	S_STK_ID VARCHAR2(100 BYTE), 
	NSE_CODE VARCHAR2(100 BYTE), 
	NSE_CLOSE NUMBER(16,2), 
	BSE_CODE VARCHAR2(100 BYTE), 
	BSE_CLOSE NUMBER(16,2), 
	FF_N1 NUMBER(16,2), 
	FF_N2 NUMBER(16,2), 
	FF_N3 NUMBER(16,2), 
	FF_N4 NUMBER(16,2), 
  ...
  TABLESPACE HHI_TBS ;
--------------------------------------------------------
--  DDL for Index CT_PK_HI_EQUITY_CHECK
--------------------------------------------------------

  CREATE INDEX CT_PK_HI_EQUITY_CHECK ON HI_EQUITY_CHECK (SOURCE, SECURITY, NAV_DATE) 
