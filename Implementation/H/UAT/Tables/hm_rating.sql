...
--------------------------------------------------------
  ...
  CREATE TABLE HM_RATING 
   (	PKID NUMBER(5,0), 
	...
	GROUPINGMASTER VARCHAR2(100 BYTE), 
	REPORTORDER NUMBER(5,0), 
	RATINGMAPPING VARCHAR2(100 BYTE), 
  ...
  TABLESPACE HM_TBS ;
--------------------------------------------------------
--  DDL for Index CT_UK_HRATING
--------------------------------------------------------

  CREATE UNIQUE INDEX CT_UK_HRATING ON HM_RATING (RATING, RATINGAGENCY) 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 65536 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE HHINDX_TBS ;
--------------------------------------------------------
--  Constraints for Table HM_RATING
--------------------------------------------------------

  ALTER TABLE HM_RATING MODIFY (CR_ID NOT NULL ENABLE);
 
  ALTER TABLE HM_RATING MODIFY (CR_DT NOT NULL ENABLE);
 
  ALTER TABLE HM_RATING MODIFY (ACTIVE NOT NULL ENABLE);
 
  ALTER TABLE HM_RATING MODIFY (ACTIVATION_DT NOT NULL ENABLE);
 
  ALTER TABLE HM_RATING MODIFY (DEACTIVATION_DT NOT NULL ENABLE);
