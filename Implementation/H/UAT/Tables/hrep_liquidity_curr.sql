...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HREP_LIQUIDITY_CURR
--------------------------------------------------------

  CREATE TABLE HREP_LIQUIDITY_CURR 
   (	COMPANY VARCHAR2(100 BYTE), 
	...
	RELATED_PARTY_NAME VARCHAR2(500 BYTE), 
  ...
  TABLESPACE HHS_TBS ;
--------------------------------------------------------
--  Constraints for Table HREP_LIQUIDITY_CURR
--------------------------------------------------------

  ALTER TABLE HREP_LIQUIDITY_CURR MODIFY (CR_ID NOT NULL ENABLE);
 
  ALTER TABLE HREP_LIQUIDITY_CURR MODIFY (CR_DT NOT NULL ENABLE);
 
  ALTER TABLE HREP_LIQUIDITY_CURR MODIFY (ACTIVE NOT NULL ENABLE);
 
  ALTER TABLE HREP_LIQUIDITY_CURR MODIFY (ACTIVATION_DT NOT NULL ENABLE);
 
  ALTER TABLE HREP_LIQUIDITY_CURR MODIFY (DEACTIVATION_DT NOT NULL ENABLE);
