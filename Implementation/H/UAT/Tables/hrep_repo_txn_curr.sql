...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HREP_REPO_TXN_CURR
--------------------------------------------------------

  CREATE TABLE HREP_REPO_TXN_CURR 
  ...
  TABLESPACE HHI_TBS ;
--------------------------------------------------------
--  Constraints for Table HREP_REPO_TXN_CURR
--------------------------------------------------------

  ALTER TABLE HREP_REPO_TXN_CURR MODIFY (CR_ID NOT NULL ENABLE);
 
  ALTER TABLE HREP_REPO_TXN_CURR MODIFY (CR_DT NOT NULL ENABLE);
 
  ALTER TABLE HREP_REPO_TXN_CURR MODIFY (ACTIVE NOT NULL ENABLE);
 
  ALTER TABLE HREP_REPO_TXN_CURR MODIFY (ACTIVATION_DT NOT NULL ENABLE);
 
  ALTER TABLE HREP_REPO_TXN_CURR MODIFY (DEACTIVATION_DT NOT NULL ENABLE);
