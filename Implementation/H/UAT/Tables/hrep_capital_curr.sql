...
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table HREP_CAPITAL_CURR
--------------------------------------------------------

  CREATE TABLE HREP_CAPITAL_CURR 
  ...
  TABLESPACE HHS_TBS ;
--------------------------------------------------------
--  Constraints for Table HREP_CAPITAL_CURR
--------------------------------------------------------

  ALTER TABLE HREP_CAPITAL_CURR MODIFY (CR_ID NOT NULL ENABLE);
 
  ALTER TABLE HREP_CAPITAL_CURR MODIFY (CR_DT NOT NULL ENABLE);
 
  ALTER TABLE HREP_CAPITAL_CURR MODIFY (ACTIVE NOT NULL ENABLE);
 
  ALTER TABLE HREP_CAPITAL_CURR MODIFY (ACTIVATION_DT NOT NULL ENABLE);
 
  ALTER TABLE HREP_CAPITAL_CURR MODIFY (DEACTIVATION_DT NOT NULL ENABLE);
