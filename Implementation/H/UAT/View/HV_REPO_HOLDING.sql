  ...
  FROM hm_SCHEME scheme,
    ...
    (SELECT accbal.scheme,
      ...
      END)                  AS net_current_assets,*/
       sum(case when accbal.security is null or accbal.control_ac in ('010103') then 0 else accbal.amount*-1 end) as net_current_assets,
