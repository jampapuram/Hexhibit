  ...
  CREATE OR REPLACE  VIEW DT_TIME_DIM_SEC_HOLD_CURR (SEC_HOLD_ID, TRANS_DATE, DAY_ID, WEEK_OF_YEAR, MONTH_ID, MONTH_END_IND, YEAR_MONTH_ID, FISC_NUM_IND_QUARTER, QUARTER_END_DATE, YEAR_ID) AS 
